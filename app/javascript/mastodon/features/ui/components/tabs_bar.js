...
export const links = [
  ...
  <NavLink className='tabs-bar__link' to='/timelines/tag/Biete'><Icon className='column-link__icon' id='book' fixedWidth /><FormattedMessage id='tabs_bar.biete' defaultMessage='BIETE' /></NavLink>,
  <NavLink className='tabs-bar__link' to='/timelines/tag/Suche'><Icon className='column-link__icon' id='search' fixedWidth /><FormattedMessage id='tabs_bar.suche' defaultMessage='SUCHE' /></NavLink>,
];
